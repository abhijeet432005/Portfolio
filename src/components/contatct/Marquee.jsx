      ...
      <div className="inline-flex shrink-0">
        {items.map((text, index) => (
          <span
            ...
            className="inline-flex items-center px-8 shrink-0"
          >
            {text} 
            <div className="ml-24 overflow-hidden w-5 h-5 mr-10">
                <div className="bg-white border-gold border-5 w-full h-full rounded-full"></div>
            </div>
          </span>
        ))}
      </div>
